...
public class MainWaliActi extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (success) {
			...
			// "WebcomicPlus Folder has been created",
	...
	private class MyPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, int position) {
			...
			if (previous <= current) {
				...
				loadwebviewforward();
				// Toast.makeText(getApplicationContext(),
				// String.valueOf(previous)+"<-prev cur->"+String.valueOf(current),
				// Toast.LENGTH_LONG).show();
			} else {
				SaveZoom();
				loadwebviewbck();
				// Toast.makeText(getApplicationContext(), "bck called",
				// Toast.LENGTH_LONG).show();
			}
					...
					for (Element element : elements) {
						...
						if (element.hasAttr("src")) {
							...
							if (i == 8) {
								...
								Log.d("dat", dat);
								// Toast.makeText(getApplicationContext(),
								// dat.toString(), Toast.LENGTH_LONG).show();
							}
						}
					}
				} catch (IOException e) {
	...
	public synchronized void loadwebview() {
		...
		if (!isOnline()) {
			Toast.makeText(getApplicationContext(), "Please turn on Wi-Fi/3g",
					Toast.LENGTH_LONG).show();
		}
		t = (TextView) findViewById(R.id.textView1);
		...
		month1 = ap.getmonth();
		date1 = ap.getdate();
		t.setText(String.valueOf(month1) + "-" + String.valueOf(date1) + "-"
		...
		wS.setAppCachePath(getApplicationContext().getCacheDir()
				.getAbsolutePath());
		...
		ref.execute();
		// Toast.makeText(getApplicationContext(), dat.toString(),
		// Toast.LENGTH_LONG).show();
	}
	...
	public synchronized void loadwebviewforward() {
		if (!isOnline()) {
			// Toast.makeText(getApplicationContext(),
			// "Please turn on Wi-Fi/3g", Toast.LENGTH_LONG).show();
		}
	...
	/**** ANIMATOR ****/
	public class ZoomOutPageTransformer implements ViewPager.PageTransformer // Animate
																				// swipes
	{
		private static final float MIN_SCALE = 0.85f;
		private static final float MIN_ALPHA = 0.5f;

		public void transformPage(View view, float position) { // Code to
																// animater
																// transitions
																// of fragments
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.feeed:
			if (isOnline()) {
				CharSequence colors[] = new CharSequence[] { "C&H", "Garfield",
						"Doonesbury", "Non Sequitur", "Peanuts", "FoxTrot",
						"Pearls Before Swine", "Dilbert Classics", "Luann",
						"Big Nate", "For Better or For Worse", "Stone Soup",
						"Marmaduke", "The Argyle Sweater", "Cul de Sac",
						"Jump Start", "Close To Home", "Rose is Rose",
						"F minus", "Brevity", "Eric The Circle",
						"9 Chicweed Lane", "Red and Rover", "B.C.",
						"Wizard of ID", "Last Kiss", "Basic Instructions",
						"Dark Side of the Horse", "The K Chronicles", "Cathy",
						"Ziggy", "Herman", "Pickles", "Get Fuzzy", "Adam@Home",
						"That is Priceless", "Dick Tracy", "PibGorn" };
				...
				builder.setItems(colors, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 9:
							...
							break;
						case 10:
							ap.setfeed("http://www.gocomics.com/forbetterorforworse/");
							break;
						case 11:
							ap.setfeed("http://www.gocomics.com/stonesoup/");
							break;
						case 12:
							ap.setfeed("http://www.gocomics.com/theargylesweater/");
							break;
						case 13:
							ap.setfeed("http://www.gocomics.com/culdesac/");
							break;
						case 14:
							ap.setfeed("http://www.gocomics.com/jumpstart/");
							break;
						case 15:
							ap.setfeed("http://www.gocomics.com/closetohome/");
							break;
						case 16:
							ap.setfeed("http://www.gocomics.com/marmaduke/");
							break;
						case 17:
							ap.setfeed("http://www.gocomics.com/roseisrose/");
							break;
						case 18:
							ap.setfeed("http://www.gocomics.com/fminus/");
							break;
						case 19:
							ap.setfeed("http://www.gocomics.com/brevity/");
							break;
						case 20:
							ap.setfeed("http://www.gocomics.com/eric-the-circle/");
							break;
						case 21:
							ap.setfeed("http://www.gocomics.com/9chickweedlane/");
							break;
						case 22:
							ap.setfeed("http://www.gocomics.com/redandrover/");
							break;
						case 23:
							ap.setfeed("http://www.gocomics.com/bc/");
							break;
						case 24:
							ap.setfeed("http://www.gocomics.com/wizardofid/");
							break;
						case 25:
							ap.setfeed("http://www.gocomics.com/lastkiss/");
							break;
						case 26:
							ap.setfeed("http://www.gocomics.com/basicinstructions/");
							break;
						case 27:
							ap.setfeed("http://www.gocomics.com/darksideofthehorse/");
							break;
						case 28:
							ap.setfeed("http://www.gocomics.com/thekchronicles/");
							break;
						case 29:
							ap.setfeed("http://www.gocomics.com/herman/");
							break;
						case 30:
							ap.setfeed("http://www.gocomics.com/pickles/");
							break;
						case 31:
							ap.setfeed("http://www.gocomics.com/getfuzzy/");
							break;
						case 32:
							ap.setfeed("http://www.gocomics.com/adamathome/");
							break;
						case 33:
							ap.setfeed("http://www.gocomics.com/that-is-priceless/");
							break;
						case 34:
							ap.setfeed("http://www.gocomics.com/dicktracy/");
							break;
						case 35:
							ap.setfeed("http://www.gocomics.com/dinosaur-comics/");
							break;
						case 36:
							ap.setfeed("http://www.gocomics.com/pibgorn/");
							break;
						case 37:
							ap.setfeed("http://www.gocomics.com/frazz/");
							break;
						case 38:
							ap.setfeed("http://www.gocomics.com/lio/");
							break;
						}
						startvp();
					}
				...
				Toast.makeText(getApplicationContext(),
						"Disconnected from the internet!", Toast.LENGTH_LONG)
						.show();
			}
			return true;
		case R.id.clndr:
	...
	/*
	 * class AttemptLogin extends AsyncTask<String, String, String> // Thread
	 * that sends the data for verification { boolean failure = false;
	 * 
	 ...
	 * ArrayList<NameValuePair>(); params.add(new BasicNameValuePair("id",
	 * String.valueOf(id))); Log.d("request!", "starting"); // getting product
	 * details by making HTTP request JSONObject json =
	 * jsonParser.makeHttpRequest(LOGIN_URL, "POST", params); // check your log
	 * for json response // json success tag success = json.getInt(TAG_SUCCESS);
	 * url=json.getString(TAG_URL); Log.d("Fetch Successful!", json.toString());
	 * 
	 * return json.getString(TAG_MESSAGE); } catch (JSONException e) {
	 * e.printStackTrace(); } return null; } protected void onPostExecute(String
	 * file_url) { Log.d("URL--------->",file_url); ap.setfeed(url); startvp();
	 * 
	 * //Toast.makeText(getApplicationContext(), String.valueOf(id),
	 * Toast.LENGTH_LONG).show(); //Toast.makeText(getApplicationContext(),
	 * String.valueOf(url), Toast.LENGTH_LONG).show(); } }
	 */
	...
	class RetrieveFeedTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			// dialog.show();
			Toast.makeText(getApplicationContext(),
					"Downloading image to /CAHRerun", Toast.LENGTH_LONG).show();
		}
			...
			try {
				...
				if (myBitmap != null) {
					try {
						...
						share.putExtra(
								Intent.EXTRA_STREAM,
								Uri.parse("file:///sdcard/temp_image_gigabyte.jpeg"));
	...
	private void GetZoom() {
		try {
			...
			if (zoomlevel.length() > 0) {
				...
				// Toast.makeText(getApplicationContext(), "100",
				// Toast.LENGTH_LONG).show();
			}
		} catch (Exception ex) {
	...
	private void SaveZoom() {
		try {
			// Toast.makeText(getApplicationContext(), "save zoom",
			// Toast.LENGTH_LONG).show();
			SharedPreferences settings = getSharedPreferences(PREFS_Zoom, 0);
